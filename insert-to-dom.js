...
<aside class="sidebar no-print">
  <!-- $ Jag använder aside istället för div för att göra koden mer semantisk för skärmläsare. Dessutom blir det enklare för mig själv att läsa $ -->
  <div class="os-v2-container">
    <!-- $ denna div håller svg bilden och "Home" texten tillsammans $ -->
...
<footer class="footer no-print">
  <!-- $ no-print klassen används för att designera det som inte ska följa i utskrift $ -->
...
<div id="navbar-hamburger" class="no-print"> 
  <!-- $ navbar-hamburger visas när skärmen blir 700px eller mindre. Sidebaren försvinner, och hamburgern visas så att man kan få en meny på mindre skärmstorlekar och mobila enheter $ -->
  <div class="navbar-hamburger-bun"></div>
    <!-- $ navbar hamburgaren skapas enbart av div element som är stylade. Dessa är dom där tomma elementen. $ -->
  <div class="navbar-hamburger-bun"></div>
  <div class="navbar-hamburger-bun"></div>
</div>
`;
